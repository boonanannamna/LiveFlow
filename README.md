...
| ไฟล์ | ใช้ทำอะไร |
|---|---|
| `LiveFlow_0.1.9_x64-setup.exe` | ไฟล์ที่ผู้ใช้ต้องดาวน์โหลดและเปิดติดตั้ง |
| `LiveFlow_0.1.9_x64-setup.exe.sig` | ลายเซ็นสำหรับระบบอัปเดต ไม่ต้องเปิดเอง |
...
เครื่องที่ใช้รุ่น `0.1.8` ซึ่งมี URL อัปเดตเดิมไม่ถูกต้อง ต้องติดตั้ง `0.1.9` ด้วยตัวเองหนึ่งครั้ง หลังจากนั้นจึงรองรับอัปเดตอัตโนมัติจาก URL ที่แก้ไขแล้ว
